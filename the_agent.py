...
#en esta parte del código hay varias funciones que se encargan de distinas tareas. como construr CNN oara el agente,
#crear acciones randome conforme a la creación de figuras
#checar si hay frames en etapas terminales para aprender de ello. 
